<?php
/**
 * Adds Borderless_Social_Media_Icons widget.
 */
class Borderless_Social_Media_Icons extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        <!-- front display here -->
        <div class="borderless-widget social-media-icons <?php echo $instance['alignment'] .' '. $instance['color'] .' '. $instance['direction'] ?>">
            <?php if($behance) { ?>
                <a href="<?php echo $behance; ?>" target="_blank" title="Behance" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($dribbble) { ?>
                <a href="<?php echo $dribbble; ?>" target="_blank" title="Dribbble" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($facebook) { ?>
                <a href="<?php echo $facebook; ?>" target="_blank" title="Facebook" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($github) { ?>
                <a href="<?php echo $github; ?>" target="_blank" title="Github" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($instagram) { ?>
                <a href="<?php echo $instagram; ?>" target="_blank" title="Instagram" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($linkedin) { ?>
                <a href="<?php echo $linkedin; ?>" target="_blank" title="Linkedin" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($medium) { ?>
                <a href="<?php echo $medium; ?>" target="_blank" title="Medium" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($pinterest) { ?>
                <a href="<?php echo $pinterest; ?>" target="_blank" title="Pinterest" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($reddit) { ?>
                <a href="<?php echo $reddit; ?>" target="_blank" title="Reddit" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($rss) { ?>
                <a href="<?php echo $rss; ?>" target="_blank" title="RSS" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($snapchat) { ?>
                <a href="<?php echo $snapchat; ?>" target="_blank" title="Snapchat" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($tiktok) { ?>
                <a href="<?php echo $tiktok; ?>" target="_blank" title="TikTok" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($twitch) { ?>
                <a href="<?php echo $twitch; ?>" target="_blank" title="Twitch" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($twitter) { ?>
                <a href="<?php echo $twitter; ?>" target="_blank" title="Twitter" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($vimeo) { ?>
                <a href="<?php echo $vimeo; ?>" target="_blank" title="Vimeo" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($wechat) { ?>
                <a href="<?php echo $wechat; ?>" target="_blank" title="WeChat" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($whatsapp) { ?>
                <a href="<?php echo $whatsapp; ?>" target="_blank" title="WhatsApp" class="social-media-icons__item">
            ...
            <?php } ?>
            <?php if($youtube) { ?>
                <a href="<?php echo $youtube; ?>" target="_blank" title="Youtube" class="social-media-icons__item">
    ...
    public function form( $instance ) {
        ...
        <p>
			...
			<select id="<?php echo $this->get_field_id('alignment'); ?>" name="<?php echo $this->get_field_name('alignment'); ?>" class="widefat">
                <option value='social-media-icons--align-left'<?php selected( $alignment, 'social-media-icons--align-left'); ?>><?php _e( 'Left', 'borderless' ); ?></option>
                <option value='social-media-icons--align-center'<?php selected( $alignment, 'social-media-icons--align-center'); ?>><?php _e( 'Center', 'borderless' ); ?></option> 
                <option value='social-media-icons--align-right'<?php selected( $alignment, 'social-media-icons--align-right'); ?>><?php _e( 'Right', 'borderless' ); ?></option> 
                <option value='social-media-icons--align-space-between'<?php selected( $alignment, 'social-media-icons--align-space-between'); ?>><?php _e( 'Space Between', 'borderless' ); ?></option> 
                <option value='social-media-icons--align-space-around'<?php selected( $alignment, 'social-media-icons--align-space-around'); ?>><?php _e( 'Space Around', 'borderless' ); ?></option> 
                <option value='social-media-icons--align-space-evenly'<?php selected( $alignment, 'social-media-icons--align-space-evenly'); ?>><?php _e( 'Space Evenly', 'borderless' ); ?></option> 
			</select>
        </p>
        <p>
			...
			<select id="<?php echo $this->get_field_id('color'); ?>" name="<?php echo $this->get_field_name('color'); ?>" class="widefat">
                <option value='social-media-icons--primary-color'<?php selected( $color, 'social-media-icons--primary-color'); ?>><?php _e( 'Primary Color', 'borderless' ); ?></option>
                <option value='social-media-icons--secondary-color'<?php selected( $color, 'social-media-icons--secondary-color'); ?>><?php _e( 'Secondary Color', 'borderless' ); ?></option> 
                <option value='social-media-icons--tertiary-color'<?php selected( $color, 'social-media-icons--tertiary-color'); ?>><?php _e( 'Tertiary Color', 'borderless' ); ?></option>
                <option value='social-media-icons--contrast-color'<?php selected( $color, 'social-media-icons--contrast-color'); ?>><?php _e( 'Contrast Color', 'borderless' ); ?></option>
			</select>
        </p>
        <p>
			...
			<select id="<?php echo $this->get_field_id('direction'); ?>" name="<?php echo $this->get_field_name('direction'); ?>" class="widefat">
                <option value='social-media-icons--direction-row'<?php selected( $direction, 'social-media-icons--direction-row'); ?>><?php _e( 'Row', 'borderless' ); ?></option>
                <option value='social-media-icons--direction-column'<?php selected( $direction, 'social-media-icons--direction-column'); ?>><?php _e( 'Column', 'borderless' ); ?></option> 
			</select>
		</p>
        <p>
...
} // class Borderless_Social_Media_Icons ends



// register Borderless_Social_Media_Icons widget
add_action( 'widgets_init', 'register_borderless_social_media_icons' );

function register_borderless_social_media_icons() {
    register_widget( 'Borderless_Social_Media_Icons' );
}